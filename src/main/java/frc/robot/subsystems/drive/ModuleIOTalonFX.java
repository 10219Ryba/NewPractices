...
public class ModuleIOTalonFX implements ModuleIO {
  ...
  protected final MotionMagicVoltage positionVoltageRequest = new MotionMagicVoltage(0.0);
  ...
  protected final MotionMagicTorqueCurrentFOC torqueCurrentRequest =
  ...
  public void setDriveOpenLoop(double output) {
    driveTalon.setControl(
        switch (constants.DriveMotorClosedLoopOutput) {
          ...
          case TorqueCurrentFOC -> torqueCurrentRequest.withPosition(output);
        });
  }
